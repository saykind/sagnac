...
%Graphics initialization function.
    ...
    axes_titles = ["DC voltage V_0, mV", "Kerr signal \theta, \murad", ...
                   ...
                   "2f Harmonic X and Y, mV", "2f Harmonic R and Q, mV"];
    x_label = "Amplitude, V_{pp}";
    ...
    ylabel(axis_x2y2, 'X_2, mV');
    yyaxis(axis_x2y2, 'right');
    set(axis_x2y2, 'YColor', 'b');
    ylabel(axis_x2y2, 'Y_2, mV');
