...
%Create and save table with instrument information for a given experiment.
    ...
    name =      ["lockin";   "X";               "Y";        "lockinA";     "lockinB"];
    driver =    ["HF2LI";    "KDC101";          "KDC101";   "SR830";        "SR830"];
    interface = ["ziDAQ";    "Kinesis";         "Kinesis";  "gpib";         "gpib"];
    address =   [NaN;         27006521;         27006520;    12;            30];
    parameters = ...
                {{}; ...                
                {nan}; ...
                {nan}; ...
    ...
    s.Properties.CustomProperties.ExperimentDescription = "DC, PGI and PGV vs XY coordinates (KDC101).";
end
