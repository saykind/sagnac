...
%Graphics initialization function.
    ...
    ylabel(ax_norm(2), "10^6 R_{1\omega}/DC");
    ylabel(ax_norm(3), "10^3 R_{2\omega}/DC");

    % Set xticks with 15 degree step
    xticks(ax_norm(1), 0:15:max_angle);
    xticks(ax_norm(2), 0:15:max_angle);
    xticks(ax_norm(3), 0:15:max_angle);
    ...
    % Set axis labels    
    yyaxis(ax_1f(1), 'left');
    ylabel(ax_1f(1), "R_{1\omega} (uV)");
    yyaxis(ax_1f(1), 'right');
    ylabel(ax_1f(1), "\Theta_{1\omega}, deg");

    yyaxis(ax_1f(2), 'left');
    ylabel(ax_1f(2), "X_{1\omega} (uV)");
    yyaxis(ax_1f(2), 'right');
    ylabel(ax_1f(2), "Y_{1\omega} (uV)");

    % Set xticks with 15 degree step
    xticks(ax_1f(1), 0:15:max_angle);
    xticks(ax_1f(2), 0:15:max_angle);
    ...
    % Set xticks with 15 degree step
    xticks(ax_2f(1), 0:15:max_angle);
    xticks(ax_2f(2), 0:15:max_angle);
    ...
    % Set axis labels
    yyaxis(ax_3f(1), 'left');
    ylabel(ax_3f(1), "R_{3\omega} (uV)");
    yyaxis(ax_3f(1), 'right');
    ylabel(ax_3f(1), "\Theta_{3\omega}, deg");

    yyaxis(ax_3f(2), 'left');
    ylabel(ax_3f(2), "X_{3\omega} (uV)");
    yyaxis(ax_3f(2), 'right');
    ylabel(ax_3f(2), "Y_{3\omega} (uV)");

    % Set xticks with 15 degree step
    xticks(ax_3f(1), 0:15:max_angle);
    xticks(ax_3f(2), 0:15:max_angle);
