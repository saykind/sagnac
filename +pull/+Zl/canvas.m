...
%Graphics initialization function.
    ...
    % Set axis labels
    yyaxis(ax_norm(1), 'left');
    ylabel(ax_norm(1), "DC (mV)");
    yyaxis(ax_norm(1), 'right');
    ylabel(ax_norm(1), "R_{2\omega}/DC");

    yyaxis(ax_norm(2), 'left');
    ylabel(ax_norm(2), "\theta_K^X, \murad");
    yyaxis(ax_norm(2), 'right');
    ylabel(ax_norm(2), "\theta_K^Y, \murad");
